...
CONFIG_SCHEMA = {
    ...
    "position_exact_core_market_collapse_floor": {"env": "SIMMER_WEATHER_POSITION_EXACT_CORE_MARKET_COLLAPSE_FLOOR", "default": 0.12, "type": float,
                          "help": "Exact CORE/carveout hard stop: if same-day price collapses below this floor and most entry value is gone, exit even if weather still appears in-bucket."},
    "position_exact_core_market_collapse_drop_frac": {"env": "SIMMER_WEATHER_POSITION_EXACT_CORE_MARKET_COLLAPSE_DROP_FRAC", "default": 0.65, "type": float,
                          "help": "Exact CORE/carveout hard stop also requires this drawdown from the best manager-seen price."},
