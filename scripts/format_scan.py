...
def get_portfolio_stats():
    """Get paper balance and P&L from paper journal."""
    try:
        ...
        return {"balance": 10000.0, "total_pnl": 0.0, "pnl_24h": 0.0, "open_trades": 0}
...
def format_output(scan_output):
    ...
    lines.append(
        ...
        f"Paper P&L: ${portfolio['total_pnl']:.2f}"
    )
    lines.append(
