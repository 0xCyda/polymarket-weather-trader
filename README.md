...
- **Three strategies**:
  ...
  - **Punt** — hunts tail mispricings (buckets priced ≤14.9¢ where model says ≥70%), fixed $15 stake, $100/day budget cap. Runs alongside Core. CORE refuses entries below 15¢ — that's PUNT territory.
